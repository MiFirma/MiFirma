...
Note that this module is only compatible with SQLite 3.6.16 or newer.}
  ...
  s.files = [%q{API_CHANGES.rdoc}, %q{CHANGELOG.rdoc}, %q{Manifest.txt}, %q{README.rdoc}, %q{ext/sqlite3/backup.c}, %q{ext/sqlite3/database.c}, %q{ext/sqlite3/exception.c}, %q{ext/sqlite3/sqlite3.c}, %q{ext/sqlite3/statement.c}]
